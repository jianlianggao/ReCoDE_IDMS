...
```{r ch2,message=FALSE, warning=FALSE}
library(dplyr)
library(ggplot2)
library(rstan)
...
```{r ch4, message=FALSE, warning=FALSE}
...
**The following code chunk requires peak memory slightly more than 27GB**
```{r ch8}
...
```{r ch9,echo=TRUE, message=TRUE, warning=FALSE}
